...
{
    [Theory] [InlineData("Estudos de eletrônica", "estudos-de-eletronica")] [InlineData("API / C#: desenho!", "api-c-desenho")]
    ...
    [Fact] public void Yaml_round_trips()
    {
    ...
    [Fact] public void Invalid_frontmatter_is_reported()
    {
    ...
    [Fact] public async Task Traversal_is_rejected()
    {
    ...
    [Fact] public async Task Configuration_round_trips()
    {
        using var temp = new TempDirectory();
        ...
        Assert.Equal(ConfigurationStatus.Valid, read.Status);
    ...
    [Fact] public void Editor_command_is_tokenized()
    {
