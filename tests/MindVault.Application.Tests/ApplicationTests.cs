...
{
    [Fact]
    public async Task Create_fails_without_vault()
    {
    ...
    [Fact]
    public async Task Collision_gets_id_suffix()
    {
        var f = new Fixture();
    ...
    [Fact]
    public async Task Exact_id_wins()
    {
        var f = new Fixture();
    ...
    [Fact]
    public async Task Partial_title_can_be_ambiguous()
    {
        var f = new Fixture();
    ...
    private sealed class Fixture
    {
        ...
        private sealed class ConfigPort(Fixture f) : IConfigurationStore
        {
            ...
            public Task<ConfigurationRead> ReadAsync(CancellationToken _) => Task.FromResult(new ConfigurationRead(ConfigurationStatusEnum.Valid, f.Config, ConfigurationPath));
